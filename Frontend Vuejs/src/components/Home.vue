 ...
 <HeaderPage/>
   <div class="content">
     <div class="text-content">
       <div class="text">Hello, It's you again : </div>
       <div class="logo">
        <img :src="`http://localhost:8000${users.avatar}`" alt="User Avatar" />
           </div>
         ...
         <div class="job">
           <span>And you a</span>
            <div class="typing-text">
              <span class="one">{{ users.name }},</span>
              <span class="two">{{ users.gender }}.</span>
            </div>
          </div>
       </div>
       <div class="buttons">
