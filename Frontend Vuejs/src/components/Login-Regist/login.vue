  ...
  <body>
    ...
    <div style="margin-left: 500px;">
      ...
      <div class="wrapper">
        ...
        <div class="row">
          <i class="fa fa-user"><img src="../../components/icons/icons8-user-64.png" alt="" style="width: 90%;" /></i>
          <input type="text" placeholder="Email or username" v-model="field" required />
        </div>
        <div class="row">
          <i class="fas fa-lock"><img src="../../components/icons/icons8-lock-50.png" alt="" style="width: 90%;" /></i>
