    ...
    <header>
      ...
      <table class="containeres">
        ...
        <thead>
          ...
          <div>
            <img src="../../assets/image/add1.png" alt="NEW Tak" style="width: 30px; cursor: pointer;"
              @click="NewTask()" />
            <img src="../../assets/image/checklist.png" alt="NEW Tak" style="width: 30px; cursor: pointer;"
              @click="FilterDone()" />
            <img src="../../assets/image/hourglass.png" alt="NEW Tak" style="width: 30px; cursor: pointer;"
              @click="FilterTime()" />
        ...
        <tbody>
          <tr v-for="item in tasks" :key="item.id">
            ...
            <td><img src="../../assets/image/edit.png" alt="edit" style="width: 20px; cursor: pointer;"
                @click="UpdateTask(item.id)" /> <img src="../../assets/image/delete.png" alt="delete"
                style="width: 20px; cursor: pointer;" @click="DeleteTask(item.id)" /></td>
...
export default {
  ...
  methods: {
    ...
    UpdateTask(id) {
      localStorage.setItem('taskId', JSON.stringify(id)); // send id of task 
